...
## Project Structure
    ...
    ├── testapiautoteammem_111060  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_111060`
...
2. Clone this repo and `cd testapiautoteammem_111060`
